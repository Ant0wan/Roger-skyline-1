...
#    Updated: 2019/05/06 12:31:40 by abarthel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def set_network(dinfo):
    ...
    system("VBoxManage modifyvm " + dinfo['VM_name'] + " --cableconnected1 on")
    system("VBoxManage modifyvm " + dinfo['VM_name'] + " --bridgeadapter1 en0")
